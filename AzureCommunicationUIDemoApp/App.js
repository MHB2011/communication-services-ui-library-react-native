      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        <View
          ...
          <Pressable
            style={[
              styles.tabButton,
              isGroupCall ? styles.buttonOpen : styles.buttonDisabled,
            ]}
            disabled={isGroupCall}
            onPress={changeCallMeetingOption}>
            <Text
              style={!isGroupCall ? styles.textCloseStyle : styles.textStyle}>
              Group Call
            </Text>
          </Pressable>
          <Pressable
        ...
        {isGroupCall ? (
          <View>
            <Text style={styles.inputTitle}>Group call ID</Text>
            <TextInput
